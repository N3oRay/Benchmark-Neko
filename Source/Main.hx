...
class Main extends Sprite
{
	...
	private static var glFragmentShaders = [
		#if mobile
		"intro", "sonic", "kurby", "Hellokitty", "stars", "nuage", "vector", "cars", "cars2", "ring", "10.2", "10", "6286", "5733", "5", "50", "04", "36", "00", "18", "12293.0", "01", "02", "03", "1", "11", "12", "12288.0", "12290.0", "12294.0", "12297.0", 
