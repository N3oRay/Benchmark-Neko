...
#define ENABLE_REFLECTIONS true
#define ENABLE_FOG  true
#define ENABLE_SPECULAR  true
...
void CalcPixelRandom()
{
	...
	vec4 s1 = sin(time * 2.3422 + gl_FragCoord.xxxx * vec4(324.324234, 563.324234, 657.324234, 764.324234)) * 543.3423;
	...
	gRandomNormal = normalize( gPixelRandom.xyz - 1.5);
}
#endif
