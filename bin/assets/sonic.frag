...
float sonicHandL(vec3 p) {
    ...
    return sdEllipsoid(p - palmCenter, vec3(0.04, 0.055, 0.05));
}
...
float sonicSpikeC(vec3 p) {
    ...
    float tip = sdCapsule(p, base + vec3(0.0, 0.182, 0.11), base + vec3(0.0, 0.34, -0.030), 0.115);
    return min(main, tip);
}
...
float sonicSpikeSideL1(vec3 p) {
    ...
    float tip = sdCapsule(p, base + vec3(-0.00, 0.23, -0.01), base + vec3(-0.02, 0.10, -0.07), 0.02);
    return min(main, tip);
}
...
float sonicSpikeSideIL1(vec3 p) {
    ...
    float tip = sdCapsule(p, base + vec3(-0.04, 0.10, -0.03), base + vec3(-0.04, 0.10, -0.04), 0.01);
    return min(main, tip);
}
...
float sonicSpikeSideL2(vec3 p) {
    ...
    float tip = sdCapsule(p, base + vec3(-0.02, 0.08, -0.01), base + vec3(-0.13, 0.13, -0.09), 0.05);
    return min(main, tip);
}
...
float sonicQuillTop(vec3 p) {
    ...
    float tip = sdCapsule(p, base + vec3(0.0, 0.17, -0.08), base + vec3(0.0, 0.52, -0.41), 0.01);
    return min(main, tip);
}
...
float sonicQuillL(vec3 p) {
    ...
    float tip = sdCapsule(p, base + vec3(-0.06, 0.18, -0.07), base + vec3(-0.22, 0.41, -0.28), 0.04);
    return min(main, tip);
}
...
float map(vec3 p, out int partId) {
    ...
    float sSpikeSideIR1 = sonicSpikeSideIR1(p); if(sSpikeSideIR1 < d) { d = sSpikeSideIR1; partId = 21; }
    float sSpikeSideIL1 = sonicSpikeSideIL1(p); if(sSpikeSideIL1 < d) { d = sSpikeSideIL1; partId = 21; }
